...
class DataTransformationConfig:
    ## setting up path where we would be storing the pkl transformation file 
...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info(f"applying object on training and test df")
            ...
            logging.info("preprocessing done on train and test data")
